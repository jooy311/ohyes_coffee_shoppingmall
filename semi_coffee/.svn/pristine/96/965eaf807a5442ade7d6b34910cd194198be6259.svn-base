<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <!--타이틀, 현재위치-->
<form id="join" name="joinForm" action="<%=request.getContextPath()%>/coffee/index.jsp?workgroup=member&work=join_action" method="post">
...
<th scope="row">아이디</th>
<td>
	<input id="memId" name="memId" value="" type="text">
	<span id="memIdck"><img src="./member/join/btn_check2.gif"></span> (영문소문자/숫자, 4~16자)
	<span class="error" id="idch"></span>
	</td>	
</tr>
<tr>
<th scope="row">비밀번호</th>
	<td>
		<input id="memPwd" name="memPwd" value="" type="password"> (영문자/숫자/특수문자가 반드시 하나이상 포함된 6~20자)
		<span class="error" id="pwch"></span>	
	</td>
...
<th scope="row" id="nameTitle">이름 </th>
                <td>
                <input type="text" name="memName" id="memName" maxlength="20">
                <span class="error" id="namech"></span>
            </tr>
<tr class="">
<th scope="row">주소 </th>
<td>
<input id="memZip" name="memZip" readonly="readonly" maxlength="14" value="" type="text">
		<a href="#" onclick="" id="postBtn">
	<img src="./member/join/btn_zipcode.gif" alt="우편번호" onclick="execDaumPostcode()"></a><br>
	<input id="addr1" name="memAddress1" readonly="readonly" value="" type="text"> 기본주소<span class="error" id="addr1ch"></span><br>
	<input id="addr2" name="memAddress2" type="text"> 나머지주소 <span class="error" id="addr2ch"></span></td>
</tr>
<tr class="">
...
-<input id="phone2" name="memPhone2" type="text" maxlength="4">
<span class="error" id="phone2ch"></span>
-<input id="phone3" name="memPhone3" type="text" maxlength="4">
...
<div class="ec-base-box typeThinBg agreeArea" >
        <div class="content">
            <p>제1조(목적)
            <br>이 약관은 최준영 커피(전자상거래 사업자)가 운영하는 최준영 커피 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
            <br>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」</p>
            <p>제2조(정의)
            <br>① “몰”이란 최준영 커피가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
            <br>② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.<br>③ ‘회원’이라 함은 “몰”에 회원등록을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수 있는 자를 말합니다.
            <br>④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.</p>
            <p>제3조 (약관 등의 명시와 설명 및 개정) 
            <br>① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 모사전송번호, 전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수 있도록 최준영 커피 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
            ...
            <br>&nbsp; 3. 기타 “몰”이 정하는 업무
            <br>② “몰”은 재화 또는 용역의 품절 또는 기술적 사양의 변경 등의 경우에는 장차 체결되는 계약에 의해 제공할 재화 또는 용역의 내용을 변경할 수 있습니다. 이 경우에는 변경된 재화 또는 용역의 내용 및 제공일자를 명시하여 현재의 재화 또는 용역의 내용을 게시한 곳에 즉시 공지합니다.<br>③ “몰”이 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화등의 품절 또는 기술적 사양의 변경 등의 사유로 변경할 경우에는 그 사유를 이용자에게 통지 가능한 주소로 즉시 통지합니다.
            ...
            <br>③ “몰”이 회원 자격을 제한 또는 정지 시킨 후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 “몰”은 회원자격을 상실시킬 수 있습니다.
            ...
            <br>② “몰”은 불특정다수 회원에 대한 통지의 경우 1주일이상 “몰” 에 게시함으로서 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.</p>
            <p>제9조(구매신청) 
            <br>① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.
            <br>&nbsp; 1. 재화 등의 검색 및 선택<br>&nbsp; 2. 받는 사람의 성명, 주소, 전화번호, 전자우편주소(또는 이동전화번호) 등의 입력
            ...
            <br>② “몰”은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 “몰”이 약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야 합니다. 다만 “몰”이 고의 또는 과실이 없음을 입증한 경우에는 그러하지 아니합니다.</p>
            <p>제14조(환급)
            ...
            <br>④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의 내용이 표시된 광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화 등을 공급받은 날부터 3월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.</p>
            <p>제16조(청약철회 등의 효과)
            ...
            <br>③ 청약철회 등의 경우 공급받은 재화 등의 반환에 필요한 비용은 이용자가 부담합니다. “몰”은 이용자에게 청약철회 등을 이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 재화 등의 내용이 표시된 광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회 등을 하는 경우 재화 등의 반환에 필요한 비용은 “몰”이 부담합니다.
            ...
            <br>⑦ “몰”은 개인정보 보호를 위하여 이용자의 개인정보를 처리하는 자를 최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한 이용자의 개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조 등으로 인한 이용자의 손해에 대하여 모든 책임을 집니다.<br>⑧ “몰” 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다.
            ...
            <br>② “몰”은 이용자가 안전하게 인터넷 서비스를 이용할 수 있도록 이용자의 개인정보(신용정보 포함)보호를 위한 보안 시스템을 갖추어야 합니다.<br>③ “몰”이 상품이나 용역에 대하여 「표시 광고의 공정화에 관한 법률」 제3조 소정의 부당한 표시 광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다.
            ...
            <p>제22조(저작권의 귀속 및 이용제한)<br>① “몰“이 작성한 저작물에 대한 저작권 기타 지적재산권은 ”몰“에 귀속합니다.<br>② 이용자는 “몰”을 이용함으로써 얻은 정보 중 “몰”에게 지적재산권이 귀속된 정보를 “몰”의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다.
            <br>③ “몰”은 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우 당해 이용자에게 통보하여야 합니다.</p>
            <p>제23조(분쟁해결)
            <br>① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위하여 피해보상처리기구를 설치운영합니다.
        ...
        <input id="agree_service_check0" name="agree_service_check0" type="checkbox" value="1">
        <label for="agree_service_check0">동의함</label><span class="error" id="agreesch"></span></p>
    </div>
...
<div class="ec-base-box typeThinBg agreeArea">
        <div class="content">
            ...
            <p>1. 개인정보 수집목적 및 이용목적</p><p>가. 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산</p>
            ...
            <p>가. 회사 내부 방침에 의한 정보 보유 사유</p><p>o 부정거래 방지 및 쇼핑몰 운영방침에 따른 보관 : OO년</p>
        ...
        <input id="agree_privacy_check0" name="agree_privacy_check0" value="1" type="checkbox">
        <label for="agree_privacy_check0">동의함</label><span class="error" id="agree2ch"></span></p>
    </div>
</div>
<div class="ec-base-button">
	<button type="submit" ><img src="./member/join/btn_member_join2.gif" alt="" ></button>
	<button type="reset" ><img src="./member/join/btn_layer_close.gif" alt="" ></button>
</div>
</form></div></div>
...
<script type="text/javascript">
    ...
    var checkEmail = /^([0-9a-zA-Z_\.-]+)@([0-9a-zA-Z_-]+)(\.[0-9a-zA-Z_-]+){1,2}$/;//Email 유효성 검사 정규식
   	...
   	$("#memId").blur(function() {
   		if (checkID.test($("#memId").val())) {
			...
			console.log('false');
			$("#idch").text("영문소문자/숫자, 4~16자리로 입력해 주세요.");
			$("#idch").css('color', 'red');
			$("#memId").focus();
		}
   	});
   	//비밀번호 유효성
   		...
   		if (checkPWD.test($("#memPwd").val())) {
			...
			$("#pwdS").focus();
   			...
   			console.log('false');
   			$("#pwch").text("비밀번호를 입력해 주세요.");
   			$("#pwch").css('color', 'red');
			$("#memPwd").focus();
		}else if (checkPWD.test($("#memPwd").val())!=true) {
			console.log('false');
			$("#pwch").text("영문자/숫자/특수문자가 반드시 하나이상 포함된 6~20자리로 입력해 주세요.");
			$("#pwch").css('color', 'red');
			$("#memPwd").focus();
		}
   	});
   	...
   	$("#pwdS").blur(function() {
   		if ($("#memPwd").val()==$("#pwdS").val()) {
			...
			console.log('false');
			$("#pwsch").text("비밀번호와 다릅니다. 다시 입력해 주세요.");
			$("#pwsch").css('color', 'red');
			$("#pwdS").focus();
		}
   	})
    ...
    $("#join").submit(function() {
    	 if($("#agree_service_check0").is(":checked") == false) { //체크박스유효성
			$("#agreesch").text("이용약관을 동의해 주세요.");
    		$("#agreesch").css('color', 'red');
			$("#agree_service_check0").focus();
             return false;
          }else if($("#agree_privacy_check0").is(":checked") ==  false) { //체크박스유효성
        	  $("#agree2ch").text("개인정보 수집 및 이용을 동의해 주세요.");
      		$("#agree2ch").css('color', 'red');
  			$("#agree_privacy_check0").focus();
               return false;
          }else{
   	...
   	$("#memId").keyup(function() {
		...
		$("#memId").focus();
		$("#memIdck").click(function() {
			var checkID = /^(?=.*[a-zA-Z])(?=.*[0-9]).{4,16}$/g;
			if($("#memId").val()=="") {
				alert("아이디를 입력해 주세요.");
				return;
			...
			window.open("<%=request.getContextPath()%>/coffee/member/id_check.jsp?memId="
					+$("#memId").val(),"idcheck","width=400,height=50,left=450,top=150");
			$("#memId").focus();
});
