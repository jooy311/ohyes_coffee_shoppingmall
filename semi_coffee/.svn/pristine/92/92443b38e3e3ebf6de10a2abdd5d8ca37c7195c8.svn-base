...
<%
	...
	List<ProductDTO> productList=ProductDAO.getProductDAO().selectNameProduct(startRow, endRow, search, keyword, category);
                                ...
                                <div class="itemLay">
                                    <div class="thumbnail">
                                        <a href="<%=request.getContextPath()%>/coffee/index.jsp?workgroup=product&work=product_detail&no=<%=product.getpNo()%>">
                                            <img src="<%=request.getContextPath()%>/coffee/admin/product_images/<%=product.getpImage()%>" id="'<%=product.getpImage()%>'" alt="'<%=product.getpName()%>'"/>
                                        </a>
                                    </div>
