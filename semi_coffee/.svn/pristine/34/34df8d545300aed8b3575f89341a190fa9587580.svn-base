								...
								<tr>
									...
									<td><input style="width: 300px; height: 25px;"
										id="subject" name="subject" 
										 class="inputTypeText" 
										value="<%=board.getQnaTitle()%>" type="text" ><span class="error" id="subjectch"></span></td>
								</tr>
					...
					<select name="qnaCode">
								...
								<tr class="">
									<td colspan="2"><textarea style="width: 1200px;" rows="15"
											cols="100" id="contents" name="contents"><%=board.getQnaContents()%></textarea><span class="error" id="contentsch"></span></td>
								</tr>
